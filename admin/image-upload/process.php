...
$img_info["destination_folder"]				= '../../images/slider/'; //Image directory ends with / (slash)
$img_info["thumbnail_destination_folder"]	= '../img/thumbs/'; //Thumbnail directory ends with / (slash)
...
if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
	...
	if($img_info["img_res"]){
		...
		if($resize_image && $generate_thumb){
			...
			echo "<img src=\"../images/slider/$resize_image\"><br />";
			//echo "<img src=\"../img/thumbs/$generate_thumb\">";
		}
	}else{
