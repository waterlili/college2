...
<?php include 'starter.php'; ?>
    ...
    <div class="navbar navbar-default navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a class="navbar-brand" href="slider.php">آپلود هنرهای تجسمی</a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
    <?php
       $directory = '/var/www/html/naghashi/admin/tajasomi/';
...
$query =mysqli_query($_SESSION['connect'],"SELECT * FROM `tajasomi` ORDER BY id DESC");
...
for($i=$offset;$i<$newICounter;$i++) {   
  $query =mysqli_query($_SESSION['connect'],"SELECT * FROM `tajasomi` WHERE img_name='".$imgs[$i]."'");
	  if (mysqli_num_rows($query) > 0) {
	       		...
	       		<div class="col-xs-6 col-sm-3 col-md-3" id="sizeopt">
		       		<div class="thumbnail" id="thumbnail">
			       		<img src="'.$maindir. '/' .$imgs[$i].'" alt="..."  style="height: 221px !important;">
				       		<div class="caption">
									 <p class="desc">'.$char.'</p>
									 <p class="del"><a href="removetajasom.php?name='.$imgs[$i].'" class="btn btn-danger btn-xs" role="button">حذف</a></p>
									 <form method="post" action="tajasomi/tajasomi.php">
	...
	<div class="col-md-4"></div>
	      ...
	      <div class="row">
	      	<div class="col-lg-12">
	           ...
	           <form class="well" action="tajasomi/tajasomi.php" method="post" enctype="multipart/form-data">
